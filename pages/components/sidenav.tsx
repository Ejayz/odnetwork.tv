...
export default function Navbar() {
  return (
    <>
<div className="w-42 h-full shadow-md bg-white absolute" id="sidenavSecExample">
  <div className="pt-4 pb-2 px-6">
    <a href="#!">
      <div className="flex items-center">
        <div className="shrink-0">
          <Image src={"/images/odnetwork_default_profile.png"} className="rounded-full w-10" alt="Avatar" width={50} height={50}/>
        </div>
